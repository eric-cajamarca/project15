...
export class ComprasService {
  ...
  editar_correlativos_empresa(id: any, correlativo: any, token: any): Observable<any> {
  ...
  buscar_comprobante_idCliente(id: any, token: any): Observable<any> {
    console.log('id', id);
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.get(this.url + 'comprasCliente/' + id, { headers: headers });
  }
